...
FormAbout.LabelCopyright.Caption=本软件版权(1998-2011)属中控科技(ZKSoftware)所有。
...
FrameDeptAndEmpsGrid1.mdUsers.DisplayLabel[4]=当前班次
...
FormEmployeelist.Employees.DisplayLabel[32]=面部数
FormEmployeelist.Employees.DisplayLabel[33]=9.0指纹数
FormEmployeelist.Employees.DisplayLabel[34]=10.0指纹数
FormEmployeelist.Employees.DisplayLabel[35]=密码
...
fAttCalc.rmdAttException.DisplayLabel[1]=登记号码
...
formOptions.chSort.Caption=登记号码按数字大小排序（不选则按字符串大小排序）
...
fUsbSelect.rb5Code.Caption=黑白屏：5位登记号码(指纹机登记号码长度不超过5)
fUsbSelect.rb9Code.Caption=黑白屏：9位登记号码(定制，必需先导入U盘员工数据)
...
AutoUpdateForm.LB_msg.Caption=发现新版考勤软件
...
SMSForm.qryConnectUsers.DisplayLabel[0]=登记号码
...
SetSMSConnect2UsersForm.qryAllUsers.DisplayLabel[2]=登记号码
SetSMSConnect2UsersForm.qryAllUsers.DisplayLabel[3]=姓名
SetSMSConnect2UsersForm.qrySelectedUsers.DisplayLabel[0]=部门
SetSMSConnect2UsersForm.qrySelectedUsers.DisplayLabel[2]=登记号码
...
QueryUserConnect2SMSForm.qryExistConnectUsers.DisplayLabel[1]=登记号码
...
[OndutyForm]
OndutyForm.qryOnduty.DisplayLabel[0]=部门
OndutyForm.qryOnduty.DisplayLabel[1]=工号
OndutyForm.qryOnduty.DisplayLabel[2]=姓名
OndutyForm.qryOnduty.DisplayLabel[3]=职务
OndutyForm.qryOnduty.DisplayLabel[4]=归队时间